        ...
        <div class="row">
            <div class="col-lg-12">
              ...
              -->
                ...
                <!--
                <h1>Create. Contribute. Engage.</h1>
              -->
                <!--
        ...
        <div class="row"> 
              <div class="col-md-8 col-md-offset-2">
                ...
                <br>
                  ...
                  <input type="search" id="aa-search-input" class="aa-input-search input-lg" placeholder="Search for funding schemes and travel grant opportunities..." name="search" autocomplete="on" />
