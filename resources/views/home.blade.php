        ...
        <div class="row"> 
              <div class="col-lg-12 col-md-12">
                ...
                <div class="aa-input-container" id="aa-input-container">
                  ...
                  <input type="search" id="aa-search-input" class="aa-input-search" placeholder="Search for funding schemes and travel grant opportunities..." name="search" autocomplete="on" />
